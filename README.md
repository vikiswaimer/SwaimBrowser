...
Техно-минимализм с Glassmorphism эффектами:

| Элемент | Значение | Описание |
|---------|----------|----------|
| Основной фон | `#0B0B0B` | Глубокий антрацит |
| Вторичный фон | `#111111` | Панели |
| Акцент | `#0066FF` | Электрический синий |
| Validated | `#22C55E` | Приглушённый зелёный |
| Invalid | `#EF4444` | Красный для ошибок |
| Glass BG | `rgba(17,17,17,0.7)` | Полупрозрачные панели |
| Границы | `rgba(255,255,255,0.1)` | Тонкие 1px линии |

**Ключевые особенности:**
- Трёхколоночная структура (LeftPanel — BrowserView — RightPanel)
- Glassmorphism с blur-эффектами
- Большой круговой таймер в Deep Work оверлее
- Статусы гипотез с цветовым кодированием
- Метрики в реальном времени с анимацией
